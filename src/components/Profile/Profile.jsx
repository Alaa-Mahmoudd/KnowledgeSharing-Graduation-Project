...
import { ArrowLeft, CameraIcon, PencilIcon, TrashIcon, UserCircleIcon } from 'lucide-react';
...
const Profile = () => {
  ...
  if (error) {
    ...
    const getErrorConfig = (errorMessage) => {
      ...
      } else if (errorMessage.toLowerCase().includes('failed to load') || errorMessage.toLowerCase().includes('network error')) {
        return {
          icon: (
      ...
      } else if (errorMessage.toLowerCase().includes('file too large') || errorMessage.toLowerCase().includes('unsupported format')) {
        return {
          icon: (
            <svg className="h-12 w-12 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {errorConfig.showDate && (
              <div className={`w-full ${errorConfig.bgColor} rounded-lg p-4 mb-6`}>
                <div className="flex items-center justify-center space-x-2">
                  ...
                  <span className={`${errorConfig.textColor} font-medium`}>Account will be reactivated on 5/16/2025</span>
                </div>
              </div>
            )}
        ...
        >
          ...
          <div className="p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                <h3 className="text-sm font-semibold text-indigo-900 uppercase tracking-wider mb-4">Contact Information</h3>
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-indigo-900 font-medium">{profileData.email}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="p-2 bg-indigo-100 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-indigo-900 font-medium capitalize">{profileData.role}</p>
                    </div>
                  </div>
                </div>
              </motion.div>
              ...
              {!isEditing && (
                <motion.div
                  ...
                  className="bg-indigo-50 p-6 rounded-xl shadow-sm"
                >
                  <h3 className="text-sm font-semibold text-indigo-900 uppercase tracking-wider mb-4">Account Security</h3>
                  <p className="text-sm text-indigo-600 mb-6">Manage your account security settings and preferences</p>
                  <div className="space-y-4">
                    <button onClick={handleChangePassword} className="cursor-pointer w-full flex items-center justify-between p-4 bg-white rounded-lg hover:bg-indigo-100 transition-colors">
                      <div className="flex items-center gap-3">
                        <div className="p-2 bg-indigo-100 rounded-lg">
                          <svg className="h-5 w-5 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div>
                          <p className="text-sm font-medium text-indigo-900">Change Password</p>
                          <p className="text-xs text-indigo-600">Update your account password</p>
                        </div>
                      </div>
                    ...
                    <button className="cursor-pointer w-full flex items-center justify-between p-4 bg-white rounded-lg hover:bg-indigo-100 transition-colors">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-indigo-900">Privacy Settings</p>
                          <p className="text-xs text-indigo-600">Manage your privacy preferences</p>
                        </div>
                      </div>
                      <svg className="h-5 w-5 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
          ...
          <div className="p-8 border-t border-indigo-100">
            <h3 className="text-xl font-semibold text-indigo-900 mb-6">Your Posts</h3>
            ...
            {loadingPosts ? (
              ...
              >
                ...
                <h4 className="text-lg font-medium text-indigo-900 mb-2">No Posts Yet</h4>
                <p className="text-indigo-600 mb-4">You haven't created any posts yet. Start sharing your knowledge with the community!</p>
                <button
                    ...
                    <div className="p-6">
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-medium text-indigo-900">{post.userName}</p>
                      ...
                      <h4 className="text-lg font-semibold text-indigo-900 mb-3">{post.title}</h4>
                      <p className="text-indigo-700 mb-4 line-clamp-3">{post.content}</p>
